...
sites/{siteId}
  ...
  rsvpShowGallery : boolean  # 首頁要不要放「Gallery 照片迴廊」（本來在邀請函上）
...
照片迴廊在大廳都有，在這裡再放一次，等於把真正要做的那件事一路往下推。
...
- 照片：搬到大廳自己的一段「Gallery 照片迴廊」（見 13.3.1），
...
| 婚禮資訊 | 婚禮資訊／其他流程／當日流程／自訂內容（含照片迴廊的開關） |
| 桌次 | 桌次圖／桌次搜尋及名單 |
