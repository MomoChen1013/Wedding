...
**主要動作永遠只有一顆**：有還沒存的改動時是「儲存」，
都存好了、還有沒發布的版本時就換成「發布給賓客」。
狀態一直寫在旁邊（手機是寫在底列上）：

| 狀態 | 畫面上寫什麼 |
|---|---|
| 還沒存 | 尚未儲存・有還沒儲存的變更。 |
| 沒發布過 | 尚未發布・賓客還查不到自己的桌次。 |
| 已發布，沒再改 | 已發布・上次發布：2026/08/25 16:10 |
| 已發布，之後又改了 | 有未發布的變更・上次發布：2026/08/25 16:10・賓客目前看到的仍是上一版排桌。 |
