...
・**只要 \`cards/\` 裡有任何一張圖，抽卡頁就整批用它**（全有或全無，不會混在一起）
・這裡與後台都沒有卡片時，抽卡頁的按鈕會停用，底下寫「等待新人上傳照片」（沒有內建的範例卡）
...
\`\`\`json
{
  "01": { "name": "求婚那天", "rarity": "SSR", "desc": "手抖到快拿不穩戒指" },
  "02": { "name": "第一次一起旅行", "rarity": "R" },
  "03": { "name": "看海的下午", "rarity": "N" }
}
\`\`\`
